...
public:
    ...
    void setUpPointLight(Shader& lightingShader)
    {
        ...
        if (lightNumber == 1) {
            ...
            lightingShader.setVec3("pointLights[0].emission", glm::vec3(0.2f, 0.2f, 0.2f));
        ...
        else if (lightNumber == 2)
        {
            ...
            lightingShader.setVec3("pointLights[1].emission", glm::vec3(0.2f, 0.2f, 0.2f));
        ...
        else if (lightNumber == 3)
        {
            ...
            lightingShader.setVec3("pointLights[2].emission", glm::vec3(0.2f, 0.2f, 0.2f));
        ...
        else if (lightNumber == 4)
        {
            ...
            lightingShader.setVec3("pointLights[3].emission", glm::vec3(0.2f, 0.2f, 0.2f));
        ...
        else if (lightNumber == 5)
        {
            ...
            lightingShader.setVec3("pointLights[4].emission", glm::vec3(0.2f, 0.2f, 0.2f));
        ...
        else if (lightNumber == 6)
        {
            ...
            lightingShader.setVec3("pointLights[5].emission", glm::vec3(0.2f, 0.2f, 0.2f));
